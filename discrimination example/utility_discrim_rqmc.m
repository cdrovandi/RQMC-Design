function u = utility_discrim_rqmc(d,J,m_sim,prior_sims,ysim,std_sim_rep,alpha)

% death model simulations
r1 = gen_Sobol(ceil(log2(J)),1+50)'; % generate pseudo random numbers
r1 = r1(1:J,:);
...
r2 = gen_Sobol(ceil(log2(J)),2+50)'; % generate pseudo random numbers
r2 = r2(1:J,:);
